...
export function parseIngredientsWithText(recipeText) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, call('POST', '/ai/parse-ingredients', { recipeText: recipeText })];
                case 1:
                    response = _a.sent();
...
export function parseIngredientsWithUrl(recipeUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, call('POST', '/ai/parse-ingredients', { recipeUrl: recipeUrl })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.items];
            }
